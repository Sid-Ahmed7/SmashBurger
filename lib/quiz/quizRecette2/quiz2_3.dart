...
class quizRecette_2_3_Page extends StatefulWidget{

  const quizRecette_2_3_Page({super.key});

  @override
  quizRecette_2_3_State createState() => quizRecette_2_3_State();

}

class quizRecette_2_3_State extends State{
            ...
            children: [
              ...
              Card(
                  ...
                  Column(
                      children: [
                        const Text(
                          'Question 3 : Quelle type de chapelure est utilisée dans le Crispy Burger ?',
                          style: TextStyle(
                            fontSize: 18,
                        ...
                        for(var indice=0; indice<quiz_recette_2_3_choix.length; indice++ )
                          ListTile(
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(15),
                                side: const BorderSide(width: 1),),
                            iconColor: couleurIcone,
                            title: Text(quiz_recette_2_3_choix[indice]['reponse']),
                            trailing: iconCoche[indice],
                            onTap: () async {
                              setState(() {
                                reponseDonnee = quiz_recette_2_3_choix[indice]['reponse'];
                          ...
                          Visibility(
                            ...
                            child:
                          ElevatedButton(
                            child: const Text('Résultat du quiz'),
                            onPressed: () {
  ...
  bool verifReponse(reponseDonnee){
    ...
    if(reponseDonnee != quiz_recette_2_3_reponse){
      return false;
    }
    else{scoreQuiz+=1;
      return true;
