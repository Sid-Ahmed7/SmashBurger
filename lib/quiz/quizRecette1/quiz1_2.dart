...
class quizRecette_1_2_State extends State{
              ...
              Card(
                  ...
                  Column(
                      children: [
                        ...
                        for(var indice=0; indice<quiz_recette_1_2_choix.length; indice++ )
                          ListTile(
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(15),
                                side: const BorderSide(width: 1),),
                            iconColor: couleurIcone,
                            title: Text(quiz_recette_1_2_choix[indice]['reponse']),
                            trailing: iconCoche[indice],
                            onTap: () async {
                              setState(() {
                                reponseDonnee = quiz_recette_1_2_choix[indice]['reponse'];
  ...
  bool verifReponse(reponseDonnee){
    ...
    if(reponseDonnee != quiz_recette_1_2_reponse){
      return false;
    }
    else{scoreQuiz+=1;
      return true;
